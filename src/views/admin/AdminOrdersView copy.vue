        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="flexRadio" id="flexRadio1" value="closed">
              <label class="form-check-label" for="flexRadio1">關閉時段</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="flexRadio" id="flexRadio2" value="service">
              <label class="form-check-label" for="flexRadio2">服務</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="flexRadio" id="flexRadio3" value="course">
  ...
  methods:{
    ...
    renderOrders(){
      this.orders.forEach(function(item){
        ...
        <p class="booked" data-session="${item.user.address}" onclick="">${time}:00 ${item.user.name} ${product.title}</p>
        `
      })
